...
class Oneday extends StatefulWidget{
  ...
  dynamic test;
  var status;
  Oneday({this.one,this.status});
  @override

  _UpcomingtabState createState() => _UpcomingtabState();
}

class _UpcomingtabState extends State<Oneday> {
  bool isError=false;
  ...
  void initState() {
    ...
    today = DateTime.now();
    print("onedayyyy"+mathesfromserver.toString());
    getmatches();
    _createInterstitialAd();
    _createRewardedAd();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          mathesfromserver[i]['starting_at'].toString().substring(0,10).split("-")[2]+"-"+  months[int.parse(mathesfromserver[i]['starting_at'].toString().substring(0,10).split("-")[1])]+"-"+  mathesfromserver[i]['starting_at'].toString().substring(0,10).split("-")[0]
                              +" , ",
