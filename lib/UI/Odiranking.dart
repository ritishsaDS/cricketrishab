...
class Odiranking extends StatefulWidget{
  dynamic testarray;
  dynamic image;
  dynamic screen;
  Odiranking({this.testarray,this.image,this.screen});
  @override
  _TOdirankingState createState() => _TOdirankingState();
}

class _TOdirankingState extends State<Odiranking> {
